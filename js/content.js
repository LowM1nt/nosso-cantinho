...
export const CONTENT = {
  fase3: {
    objetos: [
      { chaves: ['porta', 'retrato', 'foto'], texto: 'Atrás do porta-retrato, sua letra: "nosso dia favorito é o TREZE". 💕' },
      { chaves: ['calendario', 'parede', 'mes'], texto: 'No calendário, um mês inteiro rabiscado de coração: JUNHO. 🗓️' },
      { chaves: ['travesseiro', 'cama', 'almofada'], texto: 'Sob o travesseiro, um bilhete: "vira as palavras em números — dia e depois mês — e sonha alto." ✨' },
  ...
  fase4: {
    ...
    verso: { texto: 'Devagar, sem pressa... porque com você até o tempo quer ____', resposta: ['ficar'] },
  ...
  fase5: {
    cadeados: [
      ...
      { charada: "Quantos anos de 'sim' a gente comemora? ⏳", resposta: ['dois anos', '2 anos'], hints: ['Mais que um, menos que três.', 'Por extenso, com a palavra "anos".', 'Dois anos! 💍'] },
    ],
